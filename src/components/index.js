...
import MaChartWaitingSequencePie from './ma-charts-waiting-sequence-pie/index.vue'
import MaChartWaitingStrategy from './ma-charts-waiting-strategy/index.vue'
...
import MaScatter from './ma-scatter/index.vue'
...
export default {
  install(Vue) {
    ...
    Vue.component('MaChartWaitingSequencePie', MaChartWaitingSequencePie)
    Vue.component('MaChartWaitingStrategy', MaChartWaitingStrategy)
    ...
    Vue.component('MaScatter', MaScatter)
  }
}
